...
import com.revolut.data.model.extensions.mapDataSuspended
...
fun <T, R> Flow<Data<T>>.mapDataSuspended(block: suspend (T) -> R?): Flow<Data<R>> =
    map { data -> data.mapDataSuspended(block) }
